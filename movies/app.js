...
const userInputs = addMovieModal.querySelectorAll("input"); // return an array of elements
...
const deleteMovieHandler = (movieId) => {
    ...
    movies.splice(movieIndex, 1); // delete the movie item from the array
    listRoot.children[movieIndex].remove(); // rendering of the list
...
const renderNewMovieElement = (
    ...
    const newMovieElement = document.createElement("li"); // create a new list item
    newMovieElement.className = "movie-element"; // for styling
    // list item content
...
const addMovieHandler = () => {
    ...
    // the trim function is to remove the white space
    if (
        titleValue.trim() === "" ||
        imageUrlValue.trim() === "" ||
        ratingValue.trim() === "" ||
